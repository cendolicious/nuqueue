                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('nuqueue/kelola_poli');?>">Kelola Poliklinik</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <span>Sunting Poliklinik</span>
                            </li>
                        </ul>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Sunting Poliklinik</span>
                                    </div>

                                   <form action="<?php echo site_url('Nuqueue/aksi_edit_poli') ?>" method="post">
            <br>
               <div class="form-group col-md-12">
                <?php
                    foreach ($detail_poli->result() as $key) {
                        $nama_poli = $key->nama_poli;
                        $id_poli = $key->id_poli;
                    }
                ?>
                   <label>Nama Poliklinik</label>
                      <input type="text" name="nama_poli" class="form-control" placeholder="Nama Poliklinik.." value="<?php echo $nama_poli;?>" required/>
