                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Kelola Dokter</span>
                                    </div>
                                   <div class="text-right">
                                   <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><div class="glyphicon glyphicon-plus"></div> Tambah Dokter</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr class="odd gradeX">
                                                <td style="width:30%;"> <?php echo $key->nama_dokter?> </td>
                                                <td>
                                                    <?php echo $key->nama_poli?>
                                                </td>
                                               <td>
                                                   <a href="<?php echo site_url('dashboardCS/edit_dokter/'.$key->id_dokter) ?>" type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  <a href="<?php echo site_url('dashboardCS/hapus_dokter/'.$key->id_dokter) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus dokter ini?')"><i class="fa fa-trash"></i></a>
                                               </td>
                                            </tr>
                                            <?php
                                            }
