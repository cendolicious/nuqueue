    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="dashboard">
                        <img src="<?php echo base_url(); ?>assets/layouts/layout2/img/logo-default.png" alt="logo" class="logo-default" />
											</a>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN THEME PANEL -->
                    <!-- END THEME PANEL -->
                    <h1 class="page-title"> Dashboard Rumah Sakit
                    </h1>
                    <div class="page-bar">
                            ...
                            <div class="dashboard-stat2 ">
                                <div class="display">
                                    <div class="number">
                                        ...
                                        <small>Jumlah Rumah Sakit Berstatus <span style="color:red;"><strong>Pending</strong></span></small>
                                    </div>
                                    <div class="icon">
                                ...
                                <div>
                                    <a href="" class="btn btn-primary">Verifikasi Rumah Sakit</a>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="dashboard-stat2 ">
                                <div class="display">
                                    <div class="number">
                                        <h3 class="font-red-haze">
                                            <span data-counter="counterup" data-value="2314">0</span>
                                        </h3>
                                        <small>Jumlah Rumah Sakit <span style="color:green;"><strong>Terverifikasi</strong></span></small>
                                    </div>
                                    <div class="icon">
                                ...
                                <div>
                                    <a href="" class="btn btn-primary">Kelola Data Rumah Sakit</a>
                                </div>
                            </div>
                        </div>
                    </div>
