        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php require_once('modals_dokter.php');?>
                    <div class="row">
...
<div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                    <div class="caption">
                                        <span class="caption-subject font-green sbold uppercase">Profil Saya</span>
                                    </div>
                               <a href="<?php echo site_url('nuqueue/edit_profil_rs/')?>" type="button" class="btn text-right"><i class="fa fa-pencil"></i></a>   
                                ...
                                <div class="portlet-body">
                                   ...
                                   <div>
                                        <h4 class="profile-desc-title"><?php echo $alamat_rs?></h4>
                                        <span class="profile-desc-text"> <?php
                                        if (empty($deskripsi_rs)) {
                                        ...
                                        <div class="margin-top-20 profile-desc-link">
                                            ...
                                            <a href="mailto:<?php echo $email_rs?>"><?php echo $email_rs?></a>
                                            &nbsp;&nbsp;
                                            <i class="fa fa-phone"></i>
                                            <medium><?php echo $telepon_rs?></medium>
                                            &nbsp;&nbsp;
                                            <i class="fa fa-map-marker"></i>
                                            <medium><?php
                                            if ($lat_rs == 0 || $lon_rs == 0) {
                                                echo "Lokasi belum di set.";
                                            }else{
                                                echo '<a target="_blank" href="https://maps.google.com/?q='.$lat_rs.','.$lon_rs.'">'.$lat_rs.', '.$lon_rs.'</a>';
                                            }
                                            ?></medium>
