...
<html lang="en">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="dashboard-stat2 text-center">
                               <h4>Standar URL API</h4>
                               <strong><medium>API yang dimasukkan harus sesuai dengan format standar NuQueue dengan metode POST, berikut contoh format API yang sesuai</medium></strong>
                               <div class="well">
                                   {
    ...
    "result": [
        {
            "id_pasien": "1",
            "nama_pasien": "Citra Maulidina S",
            "tgllahir_pasien": "2018-04-03",
            "alamat_pasien": "Bogor",
            "telepon_pasien": "0898312415",
            "jk_pasien": "P",
            "goldar_pasien": "O",
            "no_nik": "3204441701970099"
        }
    ]
}
                               </div>
...
<div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                   ...
                                   <form action="<?php echo site_url('dashboardCS/aksi_edit_api') ?>" method="post">
            <br>
               <div class="form-group col-md-12">
                <?php
                    foreach ($detail_rs->result() as $key) {
                        $url_api = $key->url_api;
                    }
                ?>
                   <label>URL API Pasien</label>
                      <input type="text" name="url_api" class="form-control" placeholder="URL API.." value="<?php echo $url_api;?>" required/>
               </div>
               <div class="form-group col-md-12">
     </div>
             <div class="form-row">
