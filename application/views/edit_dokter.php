                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('dashboardCS/kelola_dokter');?>">Kelola Dokter</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <span>Sunting Dokter</span>
                            </li>
                        </ul>
...
<div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                   ...
                                   <form action="<?php echo site_url('dashboardCS/aksi_edit_dokter') ?>" method="post">
            <br>
               <div class="form-group col-md-12">
                <?php
                    foreach ($detail_dokter->result() as $key) {
                        $nama_dokter = $key->nama_dokter;
                        $id_dokter = $key->id_dokter;
                    }
                ?>
                   <label>Nama Dokter</label>
                      <input type="text" name="nama_dokter" class="form-control" placeholder="Nama Dokter.." value="<?php echo $nama_dokter;?>" required/>
