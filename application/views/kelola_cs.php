        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php require_once('modals_cs.php');?>
                    <div class="row">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Kelola Customer Service</span>
                                    </div>
                                   <div class="text-right">
                                   <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><div class="glyphicon glyphicon-plus"></div> Tambah Customer Service</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($data_cs->result() as $key) {
                                            
                                            ?>
                                            <tr class="odd gradeX">
                                                <td style="width:30%;"> <?php echo $key->nama_cs?> </td>
                                                <td>
                                                    <?php echo $key->username_cs?>
                                                </td>
                                                <td>
                                                    <?php echo $key->password_cs?>
                                                </td>
                                               <td>
                                                   <a href="<?php echo site_url('Nuqueue/edit_cs/'.$key->id_cs) ?>" type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  <a href="<?php echo site_url('Nuqueue/hapus_cs/'.$key->id_cs) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus CS ini?')"><i class="fa fa-trash"></i></a>
                                               </td>
                                            </tr>
                                            <?php
                                            }
