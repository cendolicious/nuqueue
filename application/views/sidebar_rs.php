<ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        ?>">
                            <a href="<?php echo site_url('dashboardCS/dashboard_rs');?>" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                                <?php
                        if($this->uri->segment(2) == 'dashboard_rs' || $this->uri->segment(2) == 'edit_api'){
                        ...
                        ?>">
                            <a href="<?php echo site_url('dashboardCS/kelola_poli');?>" class="nav-link nav-toggle">
                        ...
                        ?>">
                            <a href="<?php echo site_url('dashboardCS/kelola_dokter');?>" class="nav-link nav-toggle"
                        ...
                        ?>">
                            <a href="<?php echo site_url('dashboardCS/kelola_jadwal');?>" class="nav-link nav-toggle disabled"
                        ...
                        ?>">
                            <a href="<?php echo site_url('dashboardCS/kelola_cs')?>" class="nav-link nav-toggle">
                        ...
                        ?>">
                            <a href="<?php echo site_url('dashboardCS/profil_rs')?>" class="nav-link nav-toggle">
