...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard Vendor - NuQueue</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="dashboard-stat2 ">
                                <h2>Selamat Datang, <?php echo $nama_rs?>!</h2>
                                <?php
  ...
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="dashboard-stat2 ">
                                <div class="display">
                                    <div class="number">
                                        <small>Jml. Rumah Sakit <span style="color:grey;"><strong>belum Terverifikasi</strong></span></small>
                                        <h3 class="font-red-haze">
                                            <span style="color:grey;"><?php echo $jml_pending->num_rows(); ?></span>
                                        </h3>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="dashboard-stat2 ">
                                <div class="display">
                                    <div class="number">
                                        <small>Jml. Rumah Sakit <span style="color:green;"><strong>Terverifikasi</strong></span></small><br/>
                                        <h3 class="font-red-haze">
                                            <span style="color:green;"><?php echo $jml_verified->num_rows(); ?></span>
                                        </h3>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="dashboard-stat2 ">
                                <div class="display">
                                    <div class="number">
                                        <small>Jml. Rumah Sakit <span style="color:red;"><strong>Terblokir</strong></span></small><br/>
                                        <h3 class="font-red-haze">
                                            <span style="color:red;"><?php echo $jml_ban->num_rows(); ?></span>
                                        </h3>
