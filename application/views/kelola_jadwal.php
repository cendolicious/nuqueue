        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php require_once('modals_jadwal.php');?>
                    <div class="row">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Kelola Jadwal</span>
                                    </div>
                                   <div class="text-right">
                                   <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><div class="glyphicon glyphicon-plus"></div> Tambah Jadwal</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr class="odd gradeX">
                                                <td style="width:20%;"> <?php echo $key->nama_dokter?> </td>
                                                <td> <?php echo $key->nama_poli ?> </td>
                                                <td>
                                                    <?php
                                                        if ($key->jadwal_poli == 'Sun'){
                                                            echo 'Minggu';
                                                        }
                                                        elseif ($key->jadwal_poli == 'Mon') {
                                                            echo 'Senin';
                                                        }elseif ($key->jadwal_poli == 'Tue') {
                                                            echo 'Selasa';
                                                        }elseif ($key->jadwal_poli == 'Wed') {
                                                            echo 'Rabu';
                                                        }elseif ($key->jadwal_poli == 'Thu') {
                                                            echo 'Kamis';
                                                        }elseif ($key->jadwal_poli == 'Fri') {
                                                            echo 'Jumat';
                                                        }elseif ($key->jadwal_poli == 'Sat') {
                                                            echo 'Sabtu';
                                                        }
                                                        
                                                    ?>
                                                </td>
                                                <td> <?php echo substr($key->jammulai_poli, 0,5).' - '.substr($key->jamselesai_poli, 0,5); ?> </td>
                                               <td>
                                                   <a href="<?php echo site_url('Nuqueue/edit_jadwal/'.$key->id_jadwal) ?>" type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  <a href="<?php echo site_url('Nuqueue/hapus_jadwal/'.$key->id_jadwal) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus jadwal ini?')"><i class="fa fa-trash"></i></a>    
                                               </td>
                                            </tr>
                                            <?php
                                            }
