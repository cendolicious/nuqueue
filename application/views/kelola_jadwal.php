                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                               ...
                                               <td>
                                                   <a href="<?php echo site_url('app/edit_jadwal/'.$key->id_jadwal) ?>" type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  <a href="<?php echo site_url('app/hapus_jadwal/'.$key->id_jadwal) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus jadwal ini?')"><i class="fa fa-trash"></i></a>    
                                               </td>
                                            </tr>
                                            <?php
                                            }
