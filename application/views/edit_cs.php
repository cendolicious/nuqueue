                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('nuqueue/kelola_cs');?>">Kelola CS</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <span>Sunting CS</span>
                            </li>
                        </ul>
...
<div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                   ...
                                   <form action="<?php echo site_url('nuqueue/aksi_edit_cs') ?>" method="post">
            <br>
               <div class="form-group col-md-12">
                <?php
                    foreach ($detail_cs->result() as $key) {
                        $nama_cs = $key->nama_cs;
                        $username_cs = $key->username_cs;
                        $id_cs = $key->id_cs;
                        $pass_cs = $key->password_cs;
                    }
                ?>
                   <label>Nama CS</label>
                      <input type="text" name="nama_cs" class="form-control" placeholder="Nama CS.." value="<?php echo $nama_cs;?>" required/>
                      <input type="hidden" name="id_cs" value="<?php echo $id_cs; ?>">
               </div>
               <div class="form-group col-md-12">
                      <label>Username CS</label>
                      <input type="text" name="username_cs" class="form-control" placeholder="Username CS.." value="<?php echo $username_cs;?>" required/>
               </div>
                <div class="form-group col-md-12">
                      <label>Password CS</label>
                      <input type="password" name="password_cs" class="form-control" placeholder="Password CS.." value="<?php echo $pass_cs;?>" required/>
               </div>
               <div class="form-group col-md-12">
     </div>
             <div class="form-row">
