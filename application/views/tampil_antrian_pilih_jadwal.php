                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('nuqueue/tampil_antrian');?>">Pilih Poliklinik</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <span>Pilih Jadwal Poliklinik</span>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        <?php
                        if (empty($data_jadwal->result())) {
                            echo "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'><div class='dashboard-stat2 text-center'><h5>Belum Ada Jadwal</h5></div></div>";
                        }
                    foreach ($data_jadwal->result() as $key) {
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="dashboard-stat2 text-center">
                               ...
                               <a href="<?php echo site_url('nuqueue/tampil_antrian_jadwal');?>/<?php echo $id_poli?>/<?php echo $key->id_jadwal?>" class="btn btn-primary">Tampil</a>
                            </div>
