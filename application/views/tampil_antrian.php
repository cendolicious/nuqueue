...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard CS - NuQueue</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                  ...
                  ?>
                    ...
                    <h3 class="text-center bold" style="margin-top:0px;">Daftar Antrian <?php echo $nama_poli;?> (<?php echo substr($jammulai_poli,0,5).' - '.substr($jamselesai_poli,0,5)?>) di <?php echo $nama_rs?> oleh <?php echo $nama_dokter?></h3>
                            ...
                            <div class="portlet light tasks-widget ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark uppercase">Sedang Diperiksa :  
                                        <?php
                                        if (empty($data_antrian_saat_ini->result())) {
                                            ...
                                            echo '<b>'.$key->no_antrian.' '.$key->nama_pasien.'</b>';
                                ...
                                <div class="portlet-body">
                                    <div class="task-content">
                                        <div class="scroller" style="height: 375px;" data-always-visible="1" data-rail-visible1="1">
                                            <!-- START TASK LIST -->
                                            <ul class="task-list">
                                                <?php
                                                ...
                                                if (empty($data_list_antrian->result())) {
                                                    echo "<div class='task-title task-title-sp bold' style='font-size:30px;'>Antrian Kosong</div>";
                                                }else{
                                                    $statAntrian = false;
                                                ...
                                                <li>
                                                    <div class="task-title">
                                                        <span class="task-title-sp">
                                                            <div style="font-size: 30px;">
                                                                <?php echo $key->no_antrian.' <b>'.$key->nama_pasien.'</b>';?>
