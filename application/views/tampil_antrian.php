            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                  ...
                  ?>
                    ...
                    <h3 class="text-center bold" style="margin-top:0px;">Daftar Antrian <?php echo $nama_poli;?> (<?php echo $jammulai_poli.' - '.$jamselesai_poli ?>) di <?php echo $nama_rs?> oleh <?php echo $nama_dokter?></h3>
