...
<div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title col-md-12 col-sm-12">
                                   ...
                                   <form action="<?php echo site_url('nuqueue/aksi_edit_profil') ?>" method="post">
            <br>
                ...
                <?php
                    foreach ($data_rs->result() as $key) {
                        $id_rs = $key->id_rs;
                       $nama_rs = $key->nama_rs;
                       $password_rs = $key->password_rs;
                       $alamat_rs = $key->alamat_rs;
                       $telepon_rs = $key->telepon_rs;
                       $deskripsi_rs = $key->deskripsi_rs;
                       $email_rs = $key->email_rs;
                       $lat_rs = $key->lat_rs;
                       $lon_rs = $key->lon_rs;
                        }
                ?>
                <div class="form-group col-md-12">
                   <label>Nama Rumah Sakit</label>
                      <input type="text" name="nama_rs" class="form-control" placeholder="Nama Rumah Sakit.." value="<?php echo $nama_rs;?>" required/>
                      <input type="hidden" name="id_rs" value="<?php echo $id_rs; ?>">
               </div>
               <div class="form-group col-md-12">
                   <label>Alamat Rumah Sakit</label>
                      <input type="text" name="alamat_rs" class="form-control" placeholder="Alamat Rumah Sakit.." value="<?php echo $alamat_rs;?>" required/>
               </div>
               <div class="form-group col-md-12">
                   <label>Deskripsi Rumah Sakit</label>
                      <input type="text" name="deskripsi_rs" class="form-control" placeholder="Deskripsi Rumah Sakit.." value="<?php echo $deskripsi_rs;?>" required/>
               </div>
               <div class="form-group col-md-6">
                   <label>Latitude</label>
                      <input type="text" name="lat_rs" class="form-control" placeholder="Latitude Rumah Sakit.." value="<?php echo $lat_rs;?>" required/>
               </div>
               <div class="form-group col-md-6">
                   <label>Longitude</label>
                      <input type="text" name="lon_rs" class="form-control" placeholder="Longitude Rumah Sakit.." value="<?php echo $lon_rs;?>" required/>
               </div>
               <div class="form-group col-md-4">
                   <label>Telepon Rumah Sakit</label>
                      <input type="text" name="telepon_rs" class="form-control" placeholder="Telepon Rumah Sakit.." value="<?php echo $telepon_rs;?>" required/>
               </div>
               <div class="form-group col-md-4">
                   <label>Email Rumah Sakit</label>
                      <input type="text" name="email_rs" class="form-control" placeholder="Email Rumah Sakit.." value="<?php echo $email_rs;?>" required/>
               </div>
               <div class="form-group col-md-4">
                   <label>Password Rumah Sakit</label>
                      <input type="password" name="password_rs" class="form-control" placeholder="Password Rumah Sakit.." value="<?php echo $password_rs;?>" required/>
               </div>
